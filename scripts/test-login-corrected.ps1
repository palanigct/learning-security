# Corrected test script for JWT login endpoint
$baseUrl = "http://localhost:8080"
$loginUrl = "$baseUrl/auth/login"  # Correct URL: /auth/login, not /security/login

# Test credentials (fixed typo: "password", not "paassword")
$credentials = @{
    username = "admin"
